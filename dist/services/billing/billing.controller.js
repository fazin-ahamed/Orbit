...
const stripe = new stripe_1.default(process.env.STRIPE_SECRET_KEY || 'sk_test_default', {
...
const recordUsageSchema = zod_1.z.object({
    resourceType: zod_1.z.enum(['ai_tokens', 'workflow_runs', 'api_calls', 'storage_mb']),
...
class BillingController {
    ...
    static async createSubscription(req, res) {
        try {
            ...
            let tenant = await (0, db_1.db)('tenants')
                .where({ id: tenantId })
